...
fold_worker_command = [
  ...
  "--merge-task-subscription", "lighter-prover-scale-0p5pct-merge-task-sub",
...
merge_task_topic          = "lighter-prover-scale-0p5pct-merge-task"
merge_task_subscription   = "lighter-prover-scale-0p5pct-merge-task-sub"
merge_result_topic        = "lighter-prover-scale-0p5pct-merge-result"
merge_result_subscription = "lighter-prover-scale-0p5pct-merge-result-sub"
