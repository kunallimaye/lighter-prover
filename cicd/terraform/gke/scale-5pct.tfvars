# ─────────────────────────────────────────────────────────────────────
# SCALE-5% config — 5% of the full-scale mainnet fleet.
#
# Validation-ladder tier 3 of 3 (1% / 3% / 5%). Sizes are 5% of the
...
#
#   5% => cells = ceil(1894 * 0.05) = 95
#         coordinators = ceil(51 * 0.05) = 3
#
# Matching synthetic load to drive (proportional): mean 0.5540 blk/s,
# p99 1.25, peak 2.05 blk/s. See docs/fleet-sizing-full-scale.md §4.1.
#
...
cluster_name        = "lighter-prover-scale-5pct"
...
# tunes the PDB threshold. minAvailable = replicas - 1 keeps at least two
# coordinators un-disruptable while allowing one-at-a-time rolling headroom.
coordinator_pdb_min_available = 2

# ── Autoscaling on Pub/Sub backlog ──
pubsub_topic        = "lighter-prover-scale-5pct-dispatch"
pubsub_subscription = "lighter-prover-scale-5pct-dispatch-sub"
hpa_target_class    = "cells"
hpa_min_replicas    = 95  # steady = tier cell count
hpa_max_replicas    = 351 # burst ceiling: ceil(7006 * 0.05) = full-scale peak (41 blk/s) at 5%
