...
def render_fungible(args, project_id, gsa_email, gcs_bucket, image_uri):
  ...
  cpu = "32" if arch == "c4a" else "30"
  mem = "64Gi" if arch == "c4a" else "60Gi"
    ...
    spec:
      ...
      - name: prover
        ...
        - name: RADIX
          value: "{args.radix}"
        - name: LEAF_COUNT
          value: "{args.leaf_count if args.leaf_count and args.leaf_count > 0 else args.radix}"
        - name: TX_PER_PROOF
          value: "1"
        - name: RUST_LOG
          value: "info"
...
def main():
  ...
  if args.emit_fungible:
    render_fungible(args, project_id, gsa_email, gcs_bucket, image_uri)
    return
