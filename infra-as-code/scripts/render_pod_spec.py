...
def render_fungible(args, project_id, gsa_email, gcs_bucket, image_uri):
  ...
  # terminationGracePeriod >= max prove time on target instance; >= 30s radix-16
  # fold guidance with comfortable headroom.
...
def main():
  ...
  parser.add_argument("--ack-deadline", type=int, default=60, help="(fungible) Pub/Sub ack deadline seconds (~2xP99; radix-16 fold ~30s)")
